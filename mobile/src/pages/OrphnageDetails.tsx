...
import mapMarkerImg from '../images/map-maker.png';
import { RectButton } from 'react-native-gesture-handler';
import api from '../services/api';

interface OrphnageDetailsRouteParams {
    id: number;
}
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.title}>{orphnage.name}</Text>
        ...
        <Text style={styles.title}>{orphnage.instructions}</Text>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {orphnage.opening_hours}</Text>
          </View>
